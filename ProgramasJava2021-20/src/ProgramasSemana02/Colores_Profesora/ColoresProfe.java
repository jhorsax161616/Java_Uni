...
public class ColoresProfe {
    ...
    public void Registar(){
        ...
        do{
            ...
            if(codUtil<=0)
                System.out.println("ERROR. Los datos debes sen >0. Vuelva a ingresar.");
        }while(codUtil<=0);
        ...
        do{
            ...
            if( !"A".equals(DescripcionOferta) && !"a".equals(DescripcionOferta) && !"B".equals(DescripcionOferta) && !"b".equals(DescripcionOferta) && !"C".equals(DescripcionOferta) && !"c".equals(DescripcionOferta))
                System.out.println("ERROR. Los datos debes sen A,a, B,b, C,c. Vuelva a ingresar.");
