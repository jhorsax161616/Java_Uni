...
public class IniciarSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectofinalventa/ImagenLogin.jpg"))); // NOI18N
    ...
    query = "select * from Usuario where NameUser='" + user +"' and PassUser='"+ passw +"'";
    ...
    try{
       ...
       if (band == 1){
           ...
           VentanaVentas VentanaAbrir = new VentanaVentas();
           VentanaAbrir.setVisible(true);
           
           this.dispose(); //Para cerrar ventana IniciarSesion
